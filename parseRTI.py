...
def parseRTIBuilderXML(xmlfile,resgraph):
    ...
    resgraph.add((URIRef(ontnamespace+"PixelCoordinateSystem"),URIRef("http://www.w3.org/1999/02/22-rdf-syntax-ns#type"),URIRef("http://www.opengis.net/ont/crs/CoordinateSystem")))
    resgraph.add((URIRef(ontnamespace+"PixelCoordinateSystem"),URIRef("http://www.opengis.net/ont/crs/axis"),URIRef(ontnamespace+"PixelCoordinateSystem_axis1")))
    resgraph.add((URIRef(ontnamespace+"PixelCoordinateSystem_axis1"),URIRef("http://www.w3.org/1999/02/22-rdf-syntax-ns#type"),URIRef("http://www.opengis.net/ont/crs/CoordinateSystemAxis")))
    resgraph.add((URIRef(ontnamespace+"PixelCoordinateSystem_axis1"),URIRef("http://www.w3.org/2000/01/rdf-schema#label"),Literal("Pixel Coordinate System X Axis")))
    resgraph.add((URIRef(ontnamespace+"PixelCoordinateSystem"),URIRef("http://www.opengis.net/ont/crs/axis"),URIRef(ontnamespace+"PixelCoordinateSystem_axis2")))
    resgraph.add((URIRef(ontnamespace+"PixelCoordinateSystem_axis2"),URIRef("http://www.w3.org/1999/02/22-rdf-syntax-ns#type"),URIRef("http://www.opengis.net/ont/crs/CoordinateSystemAxis")))
    resgraph.add((URIRef(ontnamespace+"PixelCoordinateSystem_axis2"),URIRef("http://www.w3.org/2000/01/rdf-schema#label"),Literal("Pixel Coordinate System Y Axis")))
    resgraph.add((URIRef(ontnamespace+"DomeCoordinateSystem"),URIRef("http://www.w3.org/1999/02/22-rdf-syntax-ns#type"),URIRef("http://www.opengis.net/ont/crs/3DCoordinateSystem")))
    resgraph.add((URIRef(ontnamespace+"DomeCoordinateSystem"),URIRef("http://www.opengis.net/ont/crs/axis"),URIRef(ontnamespace+"DomeCoordinateSystem_axis1")))
    resgraph.add((URIRef(ontnamespace+"DomeCoordinateSystem_axis1"),URIRef("http://www.w3.org/1999/02/22-rdf-syntax-ns#type"),URIRef("http://www.opengis.net/ont/crs/CoordinateSystemAxis")))
    resgraph.add((URIRef(ontnamespace+"DomeCoordinateSystem_axis1"),URIRef("http://www.w3.org/2000/01/rdf-schema#label"),Literal("Dome Coordinate System X Axis")))
    resgraph.add((URIRef(ontnamespace+"DomeCoordinateSystem"),URIRef("http://www.opengis.net/ont/crs/axis"),URIRef(ontnamespace+"DomeCoordinateSystem_axis2")))
    resgraph.add((URIRef(ontnamespace+"DomeCoordinateSystem_axis2"),URIRef("http://www.w3.org/1999/02/22-rdf-syntax-ns#type"),URIRef("http://www.opengis.net/ont/crs/CoordinateSystemAxis")))
    resgraph.add((URIRef(ontnamespace+"DomeCoordinateSystem_axis2"),URIRef("http://www.w3.org/2000/01/rdf-schema#label"),Literal("Dome Coordinate System Y Axis")))
    resgraph.add((URIRef(ontnamespace+"DomeCoordinateSystem"),URIRef("http://www.opengis.net/ont/crs/axis"),URIRef(ontnamespace+"DomeCoordinateSystem_axis2")))
    resgraph.add((URIRef(ontnamespace+"DomeCoordinateSystem_axis3"),URIRef("http://www.w3.org/1999/02/22-rdf-syntax-ns#type"),URIRef("http://www.opengis.net/ont/crs/CoordinateSystemAxis")))
    resgraph.add((URIRef(ontnamespace+"DomeCoordinateSystem_axis3"),URIRef("http://www.w3.org/2000/01/rdf-schema#label"),Literal("Dome Coordinate System Z Axis")))
    #print(root.children())
            ...
            for dataitem in item:
                ...
                if str(dataitem.tag)=="{http://alba.di.uminho.pt/XMLCarrier}Spheres":
                    for hitem in dataitem:
                        ...
                        resgraph.add((URIRef(namespace+str(hitem.attrib["ID"])+"_position"),URIRef("http://www.opengis.net/ont/geosparql#inSRS"),URIRef(ontnamespace+"PixelCoordinateSystem")))
                    ...
                    for hitem in dataitem:
                        ...
                        resgraph.add((URIRef(namespace+str(highlightsphereid)+"_"+str(hitem.attrib["ImageID"])+"_highlight"),URIRef("http://www.opengis.net/ont/geosparql#inSRS"),URIRef(ontnamespace+"PixelCoordinateSystem")))
                    ...
                    for hitem in dataitem:
                        ...
                        resgraph.add((URIRef(namespace+str(highlightsphereid)+"_"+str(hitem.attrib["ImageID"])+"_ld"),URIRef("http://www.opengis.net/ont/geosparql#inSRS"),URIRef(ontnamespace+"DomeCoordinateSystem")))
